...
| **Rust, now** | 3.8 | 26.2 | 6.0 | 7.3 | 63.2 | 106.5 | **106.6** | 9.38 |
| ratio vs C reference | 0.86x | 0.61x | 0.87x | 0.86x | 1.11x | 0.89x | **0.87x** | |
| absolute gap | -0.6 | -16.7 | -0.9 | -1.2 | +6.1 | -13.3 | **-15.4** | |
| **change this brought** | -0.1 | -0.1 | -0.2 | -0.3 | +0.9 | +0.2 | **+0.3** | |
...
| **Rust, now** | 7.6 | 0.15 | 15.9 | 2.6 | 26.2 | `qkv`, `proj`, `core` |

**Rust is 14.4% faster per token than the C reference it was ported from** — 106.6 ms against 122.0, 9.38 tok/s against 8.20, on the same board with byte-identical output. It beats C on 4 of the 5 stages.
